...
const index$1 = require("./index-dggckCyH.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-Ss7SDl4D.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-Ss7SDl4D.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-ziIbuMpe.js.map
