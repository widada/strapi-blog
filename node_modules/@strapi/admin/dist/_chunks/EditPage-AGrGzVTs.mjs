...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-BUBFJHNU.mjs";
...
import { u as useWebhooks } from "./useWebhooks-eL42wqFn.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-CasKV6Wo.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-AGrGzVTs.mjs.map
