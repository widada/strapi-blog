...
const useWebhooks = require("./useWebhooks-8Ang4NeH.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-pCjhmpr-.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-ZQ00gK10.js.map
