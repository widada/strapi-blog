...
const ListView$1 = lazy(() => import("./ListView-6v1XsLQK.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-6v1XsLQK.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-FGFfQfjY.mjs.map
